...
// Using inline SVGs for the specific icons in the design
const AdhdIcon = () => (
...
export default function ChainedEvents() {
  return (
    <section className="relative w-full bg-[#F7F3EA] pt-24 md:pt-32 pb-24 md:pb-48 -mt-1 overflow-hidden">
      <div className="container relative flex justify-center items-start h-full">
        ...
        >
            {/* Chains */}
            <div className="absolute top-0 left-[15%] md:left-[20%] w-8 h-24 md:h-32 -translate-y-full">
                <Image src="/images/chain.png" layout="fill" objectFit="contain" alt="chain" className="transform -rotate-6"/>
            </div>
            <div className="absolute top-0 right-[15%] md:right-[20%] w-8 h-24 md:h-32 -translate-y-full">
                <Image src="/images/chain.png" layout="fill" objectFit="contain" alt="chain" className="transform rotate-6"/>
            </div>
            ...
            <div className="mt-4 space-y-3">
                {eventItems.map((item, index) => (
                    <motion.div
                        key={index}
                        className="flex items-center justify-between bg-[#FDF0D5] p-3 rounded-lg shadow-md border border-gray-200"
         ...
         {/* Placard Image */}
        <motion.div
          className="absolute hidden lg:block bottom-[-6rem] right-[-5%] w-72 h-72 z-20"
        ...
        <p className="font-['Rock_Salt'] text-sm text-foreground/70 text-center absolute bottom-0 left-1/2 -translate-x-1/2">
