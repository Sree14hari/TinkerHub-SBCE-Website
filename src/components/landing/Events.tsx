						...
						{loading ? (
							...
							<div className='space-y-4 mt-8 md:mt-0'>
								{upcomingEvents.slice(0, 3).map((event) => (
									<div
										key={event.id}
										className="relative font-['Comic_Neue'] text-2xl shadow-[0_5px_10px_rgba(0,0,0,0.3)] text-foreground/80 leading-relaxed space-y-2 bg-[#FFF1D6] w-[900px] -rotate-[5deg] left-[40px] top-[-120px] md:top-[-140px] md:left-[45px] md:w-[552px] md:h-[50px] md:pt-[5px] rounded-[5px]">
										<BulletPoint />
										<p className='translate-y-[-14px] md:translate-y-[-26px] md:pl-[50] text-bold'>
											{event.name}
										</p>
									</div>
								))}
								<p className="relative sr-only sm:not-sr-only font-['Rock_Salt'] -rotate-[5deg] translate-x-[40%] translate-y-[-150px]">
