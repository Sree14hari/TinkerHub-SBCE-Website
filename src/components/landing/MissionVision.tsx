      ...
      <div className="container">
        <div className="grid md:grid-cols-2 gap-16 md:gap-12 items-start max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="relative md:pl-44 mb-6 font-sans font-bold text-lg text-left text-foreground/80 leading-relaxed">
          ...
          <motion.div 
            ...
            <p className="relative md:pl-44 font-bold font-sans text-lg text-left text-foreground/80 leading-relaxed">
